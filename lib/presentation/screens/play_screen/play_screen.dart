...
import 'package:amuzic/core/classes/marquee_class.dart';
...
class PlayScreen extends StatelessWidget {
  PlayScreen({required this.fullsong, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return assetAudioPlayer.builderCurrent(
      ...
      final nowPlaying = findPlayPath(fullsong, playing.audio.assetAudioPath);
                        ...
                        child: MarqueeWidget(
                            ...
                            child: MyFont.montMedium13(
                                nowPlaying.metas.artist == "<unknown>"
                                    ? "UNKNOWN ARTIST"
                                    : nowPlaying.metas.artist!.toUpperCase())),
                      ),
                    ],
                  ),
                  ZoomIn(
                      ...
                      child: TextButton.icon(
                        onPressed: () {
                          ...
                          LocalStorageSongs temp = dbsongs.firstWhere(
                              (element) =>
                                  element.id.toString() == nowPlaying.metas.id);
                          showDialog(
                              context: context,
